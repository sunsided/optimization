...
namespace widemeadows.Optimization.Tests.Hypotheses
{
    ...
    /// </summary>
    public sealed class ConjugateGradientDescent : GradientDescentBase<double, ICostGradient2<double>>
    {
        /// <summary>
        ...
        public override IOptimizationResult<double> Minimize(IOptimizationProblem<double, ICostGradient2<double>> problem)
        {

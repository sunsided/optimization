...
namespace widemeadows.Optimization.Hypotheses
{
        ...
        where TData : struct, IEquatable<TData>, IFormattable
    {
        ...
        [NotNull]
        Vector<TData> Derivative([NotNull] Vector<TData> locations, [NotNull] Vector<double> coefficients, [NotNull] Vector<TData> outputs);
        ...
        /// <returns>The partial derivatives of the evaluation function with respect to the <paramref name="coefficients"/>.</returns>
        [NotNull]
        Vector<TData> Derivative([NotNull] Vector<double> locations, [NotNull] Vector<double> coefficients);
    }
}

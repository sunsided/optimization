...
namespace WideMeadows.Optimization.GradientDescent.Conjugate
{
        ...
        where TCostFunction : IDifferentiableCostFunction<double>
    {
        ...
        protected DoublePrecisionConjugateGradientDescentBase(ILineSearch<double, TCostFunction> lineSearch)
            :base(lineSearch)
        {
        }
        ...
        public sealed override IOptimizationResult<double> Minimize(IOptimizationProblem<double, TCostFunction> problem)
        {
            ...
            var state = InitializeAlgorithm(problem, location, residuals, out direction);
        ...
        protected abstract object? InitializeAlgorithm(IOptimizationProblem<double, TCostFunction> problem, Vector<double> location, Vector<double> residuals, out Vector<double> searchDirection);
        ...
        protected abstract bool UpdateDirection(object? internalState, Vector<double> location, Vector<double> residuals, ref Vector<double> direction, ref double delta);
    }
}

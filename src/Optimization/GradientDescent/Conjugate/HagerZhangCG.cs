...
namespace WideMeadows.Optimization.GradientDescent.Conjugate
{
    ...
    public class HagerZhangCG : DoublePrecisionConjugateGradientDescentBase<IDifferentiableCostFunction<double>>, IHagerZhangLineSearchParameters
    {
        ...
        private new HagerZhangLineSearch LineSearch => (HagerZhangLineSearch)base.LineSearch;

        /// <summary>
        /// delta, used in the Wolfe conditions
        /// </summary>
        /// <value>The δ.</value>
        public double δ { get => LineSearch.δ;
            set => LineSearch.δ = value;
        }
        ...
        /// </summary>
        /// <value>The σ.</value>
        public double σ { get => LineSearch.σ;
            set => LineSearch.σ = value;
        }
        ...
        public double ε { get => LineSearch.ε;
            set => LineSearch.ε = value;
        }
        ...
        public double ω { get => LineSearch.ω;
            set => LineSearch.ω = value;
        }
        ...
        /// </summary>
        /// <value>The θ.</value>
        public double θ { get => LineSearch.θ;
            set => LineSearch.θ = value;
        }
        ...
        /// </summary>
        /// <value>The γ.</value>
        public double γ { get => LineSearch.γ;
            set => LineSearch.γ = value;
        }
        ...
        public double ρ { get => LineSearch.ρ;
            set => LineSearch.ρ = value;
        }
        ...
        /// </summary>
        /// <value>The ψ0.</value>
        public double ψ0 { get => LineSearch.ψ0;
            set => LineSearch.ψ0 = value;
        }
        ...
        /// </summary>
        /// <value>The ψ1.</value>
        public double ψ1 { get => LineSearch.ψ1;
            set => LineSearch.ψ1 = value;
        }
        ...
        /// </summary>
        /// <value>The ψ2.</value>
        public double ψ2 { get => LineSearch.ψ2;
            set => LineSearch.ψ2 = value;
        }
        ...
        public bool QuadStep { get => LineSearch.QuadStep;
            set => LineSearch.QuadStep = value;
        }
        ...
        /// <value>The α0.</value>
        /// <remarks>Range (0, ∞)</remarks>
        public double α0 { get => LineSearch.α0;
            set => LineSearch.α0 = value;
        }
        ...
        public int MaxBracketingIterations { get => LineSearch.MaxBracketingIterations;
            set => LineSearch.MaxBracketingIterations = value;
        }

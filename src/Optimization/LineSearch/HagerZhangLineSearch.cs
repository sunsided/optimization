...
namespace WideMeadows.Optimization.LineSearch
{
    ...
    public class HagerZhangLineSearch : ILineSearch<double, IDifferentiableCostFunction<double>>, IHagerZhangLineSearchParameters
    {
        ...
        public double δ
        {
            ...
            set
            {
                if (value is <= 0 or >= 0.5) throw new ArgumentOutOfRangeException(nameof(value), value, "Value must be in range (0, 0.5).");
                _δ = value;
            }
        }
        ...
        public double σ
        {
            ...
            set
            {
                if (value <= δ || value >= 1) throw new ArgumentOutOfRangeException(nameof(value), value, "Value must be in range (δ, 1).");
                _σ = value;
            }
        }
        ...
        public double ω
        {
            ...
            set
            {
                if (value is < 0 or > 1) throw new ArgumentOutOfRangeException(nameof(value), value, "Value must be in range [0, 1].");
                _ω = value;
            }
        }
        ...
        public double ρ
        {
            ...
            set
            {
                if (value <= 1) throw new ArgumentOutOfRangeException(nameof(value), value, "Value must be in greater than 1.");
                _ρ = value;
            }
        }
        ...
        /// <returns>System.Double.</returns>
        private double DetermineInitialSearchPoint(double αprev, Vector<double> location, ref FunctionValues values)
        {
            // prefetch
            var ψ0 = _ψ0;
            var ψ1 = _ψ1;
        ...
        private bool ShouldTerminate(double α, double φ0, double dφ0, double φα, double dφα) =>
            OriginalWolfeConditionsFulfilled(α, φ0, dφ0, φα, dφα)
        ...
        private static Func<double, double> GetDφ(IDifferentiableCostFunction<double> function, Vector<double> location, Vector<double> direction)
        {
        ...
        /// <param name="direction">The direction.</param>
        /// <returns>Func&lt;System.Double, System.Double&gt;.</returns>
        private static Func<double, double> Getφ(ICostFunction<double> function, Vector<double> location, Vector<double> direction)
        {
        ...
        /// </summary>
        private readonly struct FunctionValues
        {
            /// <summary>
            ...
            public FunctionValues(Func<double, double> φ, Func<double, double> dφ, double φ0, double dφ0, Vector<double> Δf0)
            {
                this.φ = φ;
                this.dφ = dφ;
                this.φ0 = φ0;

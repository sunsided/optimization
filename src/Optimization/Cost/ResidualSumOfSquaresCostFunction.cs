...
namespace WideMeadows.Optimization.Cost
{
    ...
    public class ResidualSumOfSquaresCostFunction : ITwiceDifferentiableCostFunction<double>
    {
        ...
        public IReadOnlyCollection<DataPoint<double>> TrainingSet => _trainingSet;
        ...
        public ResidualSumOfSquaresCostFunction(IDifferentiableHypothesis<double> hypothesis, IReadOnlyCollection<DataPoint<double>> trainingSet)
        {
